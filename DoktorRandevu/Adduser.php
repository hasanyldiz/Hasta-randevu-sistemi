        ...
        <div class="user-details">
          <div class="col">
            <div class="input-box">
              ...
              <input type="text" name="HastaIsimsoyisim" placeholder="" required>
            </div>
          </div>
          <div class="col">
            <div class="input-box">
              <span class="details">E-Posta</span>
              <input type="email" class="form-control" name="HastaEposta" id="exampleInputEmail1" aria-describedby="emailHelp">
          ...
          <div class="col">
            <div class="input-box">
              ...
              <input type="date" name="HastaDogumtarihi" placeholder="" required>
            </div>
          </div>
          <div class="col">
            <div class="input-box">
